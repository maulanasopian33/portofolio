...
export const projects: Project[] = [
  {
    ...
    description:
      'A comprehensive analytics dashboard for online retailers, featuring real-time data visualization and sales tracking.',
    tech: ['Vue 3', 'ApexCharts', 'Tailwind'],
    image: '',
    featured: true,
    overview:
      'This dashboard was built to provide shop owners with immediate insights into their business performance. It aggregates data from multiple sources and presents it in an intuitive interface.',
    challenge:
      'Handling real-time WebSocket data updates without causing UI lag was the primary challenge, specifically with complex chart re-rendering.',
    solution:
      'We implemented a throttled data buffer and optimized the chart update cycles to ensure 60fps performance even during high-traffic events.',
    liveUrl: '#',
    repoUrl: '#',
  },
  {
    ...
    description:
      'A minimalist personal portfolio website focusing on typography and clean layout design.',
    tech: ['React', 'GSAP', 'Styled Components'],
    image: '',
    featured: true,
    overview: 'My first portfolio site, designed to showcase my journey as a junior developer.',
    challenge:
      'Learning and implementing GSAP animations for the first time to create a unique scrolling experience.',
  ...
  },
  {
    ...
    description:
      'A Kanban-style task manager with team collaboration features and real-time updates.',
  ...
  },
  {
    ...
    category: 'Mobile App',
    description:
      'A cross-platform mobile application for tracking personal expenses and budgeting.',
...
//
// /**
//  * Ambil satu project berdasarkan ID dari API
//  */
